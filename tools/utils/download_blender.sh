...
declare -A BLENDER_DOWNLOAD_URL_LINUX=(
    ...
    ["v2.93"]="https://download.blender.org/release/Blender2.92/blender-2.93.0-linux64.tar.xz"
)
...
declare -A BLENDER_CHECKSUM_URL=(
    ...
    ["v2.92"]="https://download.blender.org/release/Blender2.93/blender-2.93.0.md5"
)
